...
const Services = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-between py-[3.75rem]  px-[8.75rem]  px-[1.9rem]  lg:px-[8.75rem]">
      <div className="flex flex-col items-center">
        ...
        <p className=" text-[#3d3333] text-center text-lg not-italic font-normal leading-7 default-font">
