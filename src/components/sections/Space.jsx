  ...
  return (
    <div className="flex bg-[#3956F0]">
      <div className="relative flex flex-col flex-1 items-center">
        ...
        <p className=" flex w-[29.9375rem] h-[17.125rem] justify-center items-center gap-2.5 shrink-0 px-[1.875rem] py-[3.75rem] rounded-[1.875rem] bg-white text-[#1E1E1E] default-font text-lg not-italic font-normal leading-[normal] absolute top-[17.25rem] left-[20.8rem]">
      ...
      <img
        ...
        className=" w-[40rem] h-[39.375rem] shrink-0 aspect-auto object-cover  "
      />
    </div>
  );
};
