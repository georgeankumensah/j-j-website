  ...
  return (
    <div className="flex bg-[#3956F0]">
      ...
      <div className="relative flex flex-1 ">
        <p className="inline-flex justify-center items-center gap-2.5 px-[1.875rem] py-[3.75rem] w-[29.93rem] h-[17.125rem] default-font rounded-[1.875rem] shrink-0  shadow-md bg-white text-[#1E1E1E] text-lg not-italic font-normal leading-[normal] absolute right-[12.17rem] top-[14.69rem]">
